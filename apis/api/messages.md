...
{% api-method-description %}
Sends a message. This method also creates a request on the first message.   
**Only Tiledesk version 2 environment \(only available on-premise\).**
{% endapi-method-description %}
...
```text
curl -v -X POST -H 'Content-Type: application/json' -u andrea.leo@f21.it:123456  -d '{"text":"hello from api"}' https://YOUR_TILEDESK_ENDPOINT/5b55e806c93dde00143163dd/requests/1234/messages
```
