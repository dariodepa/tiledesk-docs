...
You can enable special message features following this paragrafh: https://github.com/chat21/chat21-cloud-functions/blob/master/docs/api.md#message-attributes
